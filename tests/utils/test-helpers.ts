...
export const TEST_CONSTANTS = {
  ...
  MOCK_DOMAIN: PromptDomain.GENERAL,
  MOCK_TONE: PromptTone.TECHNICAL,
  ...
  // Test domains
  DOMAINS: [PromptDomain.SQL, PromptDomain.BRANDING, PromptDomain.CINE, PromptDomain.SAAS, PromptDomain.DEVOPS, PromptDomain.GENERAL],
  
  // Test tones
  TONES: [PromptTone.FORMAL, PromptTone.CASUAL, PromptTone.TECHNICAL, PromptTone.CREATIVE]
} as const;