...
import { PromptDomain, PromptTone, } from '../../src/types/prompt.js';
// Mock data generators
export function createMockQualityScore(overrides) {
    return {
        clarity: 0.8,
        specificity: 0.75,
        structure: 0.85,
...
export function createMockProcessInput(overrides) {
    return {
...
export function createMockProcessResult(overrides) {
    return {
...
export function createMockEvaluationResult(overrides) {
    return {
        score: createMockQualityScore(),
        breakdown: {
            clarity: {
...
export function createMockSavedPrompt(overrides) {
    return {
        id: 'prompt_123',
...
export function createMockComparisonResult(overrides) {
    return {
        variants: [
            {
                id: 'variant_0',
...
export function createMockOrchestrator() {
    return {
        process: jest.fn().mockResolvedValue(createMockProcessResult()),
        evaluate: jest.fn().mockResolvedValue(createMockEvaluationResult()),
        compare: jest.fn().mockResolvedValue(createMockComparisonResult()),
...
export function expectValidQualityScore(score) {
...
export function expectValidAnalysisResult(analysis) {
...
export function expectValidProcessResult(result) {
...
export function expectWithinPerformanceThreshold(duration, threshold, operation) {
